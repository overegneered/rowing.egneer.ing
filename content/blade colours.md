...
A word to the wise: *don't* put 'blades of the Isis' into a search engine. It will not give you what you're looking for. Here I've catalogued the blade colours of the rowing clubs that row in Oxford, both by [[#Blades by club|club]] and [[#Blades by colour|colour]] (so that it's easy to search both ways). The attribution for each image can be found in the [[#Attribution|attribution section]].

## Blades by club

| Club                          |                                                       Blade(s)                                                        |                                                                                                                    |                                                  |
| ----------------------------- | :-------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------: | :----------------------------------------------: |
| Balliol                       |       ![](https://upload.wikimedia.org/wikipedia/commons/c/cc/Balliol_College_Rowing_Blade.svg)<br>**General**        |                            ![[Balliol_First_Boat_Rowing_Blade.svg]]<br>**First boats**[^1]                             |                                                  |
...
[^1]: These are known as the Gordouli blades, and may only be used if the crew is in the upper half of [[divisions|Division 1]] (I think).
